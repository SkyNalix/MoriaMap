 ...
 * 
 */
<<<<<<<< HEAD:src/main/java/dev/moriamap/model/StopNameFinder.java
...
public class stopNameFinder {
    ...
    private stopNameFinder(){
>>>>>>>> 9a816bf (Rename Utils classes and functions, added to main):src/main/java/dev/moriamap/model/stopNameFinder.java
